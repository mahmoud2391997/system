...
export function createExpressApp(): express.Express {
  ...
  // Upgrade-in-place
  apiRouter.post('/workspace/tier', (req, res) => {
  ...
  apiRouter.get('/approvals', (req, res) => {
    res.json({ approvals });
  });
  ...
  apiRouter.post('/crm/contacts', (req, res) => {
    if (!features.crm_enabled) {
      return res.status(403).json({ error: 'CRM module locked in current tier', locked: true });
    }
  ...
  apiRouter.post('/crm/contacts/:id/notes', (req, res) => {
    const { id } = req.params;
  ...
  apiRouter.post('/crm/deals/stage', (req, res) => {
  ...
  apiRouter.post('/team/members', (req, res) => {
    if (!features.team_enabled) {
      return res.status(403).json({ error: 'Team module locked in current tier', locked: true });
    }
  ...
  apiRouter.post('/team/tasks', (req, res) => {
  ...
  apiRouter.post('/team/tasks/:id/status', (req, res) => {
    const { id } = req.params;
  ...
  apiRouter.post('/team/tasks/:id/time', (req, res) => {
    const { id } = req.params;
  ...
  apiRouter.delete('/team/tasks/:id', (req, res) => {
    const { id } = req.params;
  ...
  apiRouter.post('/erp/invoices', (req, res) => {
    if (!features.erp_enabled) {
      return res.status(403).json({ error: 'ERP module locked in current tier', locked: true });
    }
  ...
  apiRouter.post('/erp/inventory', (req, res) => {
    if (!features.erp_enabled) {
      return res.status(403).json({ error: 'ERP module locked in current tier', locked: true });
    }
  ...
  apiRouter.post('/erp/inventory/:id/stock', (req, res) => {
    const { id } = req.params;
  ...
  apiRouter.post('/integrations/ping', (req, res) => {
  ...
  apiRouter.post('/integrations/toggle', (req, res) => {
    const { id } = req.body;
  ...
  apiRouter.post('/policy/evaluate', (req, res) => {
  ...
  // Mount router on both '/api' and '/' so that either URL structure works flawlessly
